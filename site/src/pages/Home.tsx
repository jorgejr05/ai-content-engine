    ...
    <div className="animate-fade">
      ...
      <section className="hero container">
        ...
        <div style={{ display: 'flex', gap: '1rem', justifyContent: 'center' }}>
          <a href="/app/" className="btn-premium" style={{ height: '60px', padding: '0 3rem', fontSize: '1.1rem', textDecoration: 'none', display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '0.5rem' }}>
